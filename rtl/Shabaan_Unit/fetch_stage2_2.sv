// =====================================================================================
// Module name : fetch_stage2_2
// Purpose     : Generates the read and write addresses/enables for a LIF history BRAM
//               group (1024*64 = 65536 positions). Pure address/control-timing module. Identical
...
module fetch_stage2_2 #(
    parameter BANK_DEPTH   = 2048,                       // depth of a single physical bank - MUST be a power of 2
    parameter ACTIVE_BANKS = 32,                     // banks swept per frame (the "sweep window" size)
    parameter TOTAL_BANKS  = 33,                      // total physical banks = ACTIVE_BANKS + spare bank(s)
